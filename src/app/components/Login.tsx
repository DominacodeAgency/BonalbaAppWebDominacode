...
export default function Login({ onLogin, onInit, initializing }: LoginProps) {
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
              <p className="text-sm text-blue-800 font-medium mb-2">Primera vez usando la aplicación:</p>
              <button
                onClick={onInit}
            ...
            <div className="text-xs text-gray-500 space-y-2">
              ...
              <div className="space-y-1">
                <p>• <strong>admin</strong> / 123456 (Administrador)</p>
                <p>• <strong>empleado</strong> / 123456 (Personal de sala)</p>
              </div>
            </div>
          </div>
        </div>
